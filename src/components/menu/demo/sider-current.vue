<template>
 <div>
    <ant-code-box title="只展开当前父级菜单" :code="code" id="components-menu-demo-sider-current">
      <div slot="instance">
      ...
      <div slot="description">
        <menu-sider-current-md></menu-sider-current-md>
      </div>
    </ant-code-box>
  </div>
</template>
<script>
import MenuSiderCurrentMd from './sider-current.md'
export default {
  components: { MenuSiderCurrentMd },
  data: () => ({
    code: `
      <ant-menu mode="inline" :focus-submenu="true" xstyle="width: 240px">
        <ant-submenu xkey="sub1">
