<template>
 <div>
    <ant-code-box title="顶部导航" :code="code" id="components-menu-demo-horizontal">
      <div slot="instance">
        <ant-menu mode="horizontal" 
          :on-click="logSelectedKeys"
          :on-open-change="logOpenKeys">
      ...
      <div slot="description">
        <menu-horizontal-md></menu-horizontal-md>
      </div>
    </ant-code-box>
  </div>
</template>
<script>
import MenuHorizontalMd from './horizontal.md'
export default {
  components: { MenuHorizontalMd },
  data: () => ({
    code: `
      <template>
        <ant-menu mode="horizontal">
